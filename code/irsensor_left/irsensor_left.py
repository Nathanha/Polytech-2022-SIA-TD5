...
TOPIC_BEHAVIOR_IR_LEFT = "alphabot2/behavior/ir_left"
...
def on_irsensors(client, userdata, msg):
    ...
    if LEFT >= 1800 and CENTER >= detected and RIGHT >= 1800:
        client.publish(TOPIC_BEHAVIOR_IR_LEFT, "0 0 0 0 0 0 1")
    elif LEFT >= 1800 and CENTER < detected:
        client.publish(TOPIC_BEHAVIOR_IR_LEFT, "0.2 0.8 0.2 0.5 1 0.5 0")
    elif LEFT >= 1800 and CENTER >= detected:
        client.publish(TOPIC_BEHAVIOR_IR_LEFT, "0 0.5 0.8 0 0.5 1 0")
    elif LEFT < 1800 and CENTER < detected:
        client.publish(TOPIC_BEHAVIOR_IR_LEFT, "0.8 0.5 0 1 0.5 0 0")
...
client = MQTTClient("controler3", MQTT_HOST, MQTT_PORT, QOS)
